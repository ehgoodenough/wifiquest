...
var ThingStore = Reflux.createStore({
    data: (
        <div className="all-things">
            <Thing x={-1} y={-2} z={7} width={WIDTH*5} height={HEIGHT} image={"./assets/images/background.svg"}/>
            <Thing x={-1} y={7} z={1} width={WIDTH*6} height={HEIGHT} image={"./assets/images/ground.svg"}/>
